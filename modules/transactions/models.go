...
type Transaction struct {
	...
	TransactionFields
	PersonAccountName        string    `json:"person_account_name"`
	PersonAccountDescription string    `json:"person_account_description"`
...
type TransactionFields struct {
	...
	PersonAccountId uuid.UUID `json:"person_account_id"`
